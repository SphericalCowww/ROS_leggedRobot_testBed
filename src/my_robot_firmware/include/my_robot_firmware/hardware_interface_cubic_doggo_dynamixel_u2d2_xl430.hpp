...
namespace cubic_doggo_namespace {
    class HardwareInterfaceU2D2_cubic_doggo: public hardware_interface::SystemInterface
    {
        ...
        private:
            ...
            double  rad_positions_init_[12];
            double  rad_positions_     [12];
            double  rad_velocities_    [12];
            double  rad_efforts_       [12];
            int32_t dxl_positions_     [12];
            int32_t dxl_velocities_    [12];
            int32_t dxl_efforts_       [12];
